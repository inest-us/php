...
<body>
	...
	if (isset($_POST['posted'])) {
		...
		if ($_POST['guess'] > $number) {
			echo "<h3>Your guess is too high</h3>";
			echo "<br>The number is $number, you don't win, please play again<hr>";
		} else if ($_POST['guess'] < $number) {
			echo "<h3>Your guess is too low</h3>";
			echo "<br>The number is $number, you don't win, please play again<hr>";
		} else {
			echo "<br>The number is $number, you win, please play again<hr>";
		}
	}
	?>
